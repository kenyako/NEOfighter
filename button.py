...
class Button:
    def __init__(self, screen, width, height, inactive_color=None, active_color=None):
        self.screen = screen
    ...
    def draw(self, btn_x, btn_y, btn_text, action=None, btn_image=None,):
        ...
        if btn_text:
            ...
            image_on_btn = pygame.image.load('images\icon.png')
            image_rect = image_on_btn.get_rect(bottomright=(size[0], size[1]))
            self.screen.blit(
                image_on_btn,
                image_rect
            )
